...
reg = RandomForestClassifier(n_estimators = 1000,max_depth = 62,oob_score=True,random_state = 500,bootstrap = True, warm_start = True)
...
sample.to_csv('prediction_file_11.csv',index=False)